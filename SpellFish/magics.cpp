...
namespace Spellfish
{
    ...
    // print bitboard
    void Magics::print_bitboard(U64 bitboard)
    {
        printf("\n");
    ...
    void Magics::init_sliders_attacks(bool is_bishop)
    {
    ...
    U64 Magics::get_bishop_attacks(int square, U64 occupancy) {
    ...
    // lookup rook attacks 
    U64 Magics::get_rook_attacks(int square, U64 occupancy) {
